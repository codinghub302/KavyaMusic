...
from Kavya import app
from Kavya.core.call import Kavya
from Kavya.misc import db
from Kavya.utils.database import get_authuser_names, get_cmode
from Kavya.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Kavya.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Kavya.stop_stream(message.chat.id)
    except:
        pass
