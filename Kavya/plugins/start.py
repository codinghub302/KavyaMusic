...
from Kavya import Telegram, YouTube, app
from Kavya.misc import SUDOERS, _boot_
from Kavya.plugins.playlist import del_plist_msg
from Kavya.plugins.sudoers import sudoers_list
from Kavya.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Kavya.utils.decorators.language import LanguageStart
from Kavya.utils.formatters import get_readable_time
from Kavya.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEDb9hlKgy6vmS8TzYTI90Twi9QNBbqSQAC5QkAAnxNoFYj8ll5PdeO7DAE")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/+gxR8UB3KCEo4OTFl) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/+gxR8UB3KCEo4OTFl"
                        ),
                    ],
                ]
            )
