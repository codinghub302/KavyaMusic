...
admin_9 : "➻ **sᴛʀᴇᴀᴍ ᴇɴᴅᴇᴅ/sᴛᴏᴩᴩᴇᴅ** ❄\n│ \n└ʙʏ : {} 🥀"
admin_10 : "➻ sᴛʀᴇᴀᴍ sᴋɪᴩᴩᴇᴅ 🥺\n│ \n└ʙʏ : {0} 🥀\n\n**» ɴᴏ ᴍᴏʀᴇ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs ɪɴ** {1}, **ʟᴇᴀᴠɪɴɢ ᴠɪᴅᴇᴏᴄʜᴀᴛ.**"
...
start_2 : "**ʜᴇʏ** ᴅᴇᴀʀ , 💕**\n  **ᴛʜɪs ɪs {0}** 🥀\n **ᴀ ᴩᴏᴡᴇʀғᴜʟ ᴍᴜѕɪᴄ ᴩʟᴀʏᴇʀ ʙᴏᴛ ᴡɪᴛʜ ѕᴏᴍᴇ ᴀᴡᴇѕᴏᴍᴇ ᴀɴᴅ ᴜѕᴇғᴜʟ ғᴇᴀᴛᴜʀᴇѕ.**\n\n**ѕᴜᴘᴘᴏʀᴛᴇᴅ ᴘʟᴀᴛᴇꜰᴏʀᴍѕ : ʏᴏᴜᴛᴜʙᴇ, ѕᴘᴏᴛɪꜰʏ, ʀᴇѕѕᴏ, ᴀᴘᴘʟᴇ ᴍᴜѕɪᴄ ᴀɴᴅ ѕᴏᴜɴᴅᴄʟᴏᴜᴅ.**"
...
help_2 : "**» ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʜᴇʟᴩ ᴍᴇɴᴜ.**"
...
#Ping
ping_1 : "» ᴩɪɴɢɪɴɢ ʙᴀʙʏ..."
ping_2 : "🏓 ᴩᴏɴɢ : `{0}ᴍs`\n\n<b><u>{1} sʏsᴛᴇᴍ sᴛᴀᴛs :</u></b>\n\n✨ ᴜᴩᴛɪᴍᴇ : {2}\n❄ ʀᴀᴍ : {3}\n💫 ᴄᴩᴜ : {4}\n🔮 ᴅɪsᴋ : {5}\n☁️ ᴩʏ-ᴛɢᴄᴀʟʟs : `{6}ᴍs`\n\n|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [ᴀɴᴏɴʏᴍᴏᴜs](https://t.me/UniqueMrRaj) 🥀 ||"
...
stream_3 : "➻ **sᴛᴀʀᴛᴇᴅ sᴛʀᴇᴀᴍɪɴɢ**\n\n✨ **ᴛɪᴛʟᴇ:** {0}\n🕕 **ᴅᴜʀᴀᴛɪᴏɴ:** {1}\n🥀 **ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ:** {2} "
stream_4 : "➻ **sᴛᴀʀᴛᴇᴅ sᴛʀᴇᴀᴍɪɴɢ**\n\n✨ **ᴛɪᴛʟᴇ :** [{0}]({1})\n🕕 **ᴅᴜʀᴀᴛɪᴏɴ :** {2}\n🥀 **ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ :** {3}"
